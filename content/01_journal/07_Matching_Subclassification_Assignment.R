...
summary(lm_2)
Answer2<-"The naive estimate of the treatment effect is about 25.22."
Answer2
...
Answer3_1<-"After the Coarsened Exact Matching the estimate for the ATE is 15.27."
Answer3_1
...
Answer3_2<-"After the Nearest-Neighbor Matching the estimate for the ATE is 14.95."
Answer3_2
...
Answer3_3<-"After the Inverse Probability Weighting the estimate for the ATE is 14.95."
Answer3_3
